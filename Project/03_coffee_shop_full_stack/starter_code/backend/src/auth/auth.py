...
AUTH0_DOMAIN = 'coffee-shop-udacity-project.us.auth0.com'
ALGORITHMS = ['RS256']
API_AUDIENCE = 'coffee'
...
def verify_decode_jwt(token):
    ...
    jwt_keys = json.loads(json_url.read())
    ...
    for jwt_key in jwt_keys['keys']:
        if jwt_key['kid'] == unverified_header['kid']:
            rsa_key = {
                'kty': jwt_key['kty'],
                'kid': jwt_key['kid'],
                'use': jwt_key['use'],
